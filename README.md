...
There are a few options for starting the server, four of which are below. Once the server has been started, go to [http://localhost:9082/servlet-nio/](http://localhost:9082/servlet-nio/) to view the sample.
